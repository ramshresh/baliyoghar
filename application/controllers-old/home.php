...
class Home extends CI_Controller {
    ...
    public function costSharing() {
        ...
        $this->loadpage($data, 'CostSharing', 'Cost Sharing Party | BCIPN');
    }

    public function help() {
        $data['helpcontent'] = $this->functionsmodel->getHelpContent();
        $this->loadpage($data, 'Help', 'HELP | BCIPN');
    }
    ...
    public function newcourses() {
        ...
        $this->loadpage($data, 'Courses', 'Add new event | BCIPN');
    }

    public function newCoverage() {
        $data['coverage_level_list'] = $this->functionsmodel->getCoverageLevel();
        $this->loadpage($data, 'CoverageEntry', 'Add new coverage | BCIPN');
    }
    ...
    public function editCoverage() {
        ...
        if ($coverage_name == '') {
            $data['coverage_level_list'] = $this->functionsmodel->getCoverageLevel();
            $this->loadpage($data, 'CoverageEntry', 'Request failed | BCIPN');
        } else {
            ...
            $this->loadpage($data, 'EditCoverage', 'Manage Coverage | BCIPN');
        }
    }
    ...
    public function newevents() {
        ...
        $this->loadpage($data, 'Events', 'Add new event | BCIPN');
    }
    ...
    public function event() {
        ...
        $this->loadpage($data, 'EventManagement', 'View recent event | BCIPN');
    }
    ...
    public function people() {
        ...
        $this->loadpage($data, 'PeopleManagement', 'View people | BCIPN');
    }
    ...
    public function course() {
        ...
        $this->loadpage($data, 'CourseManagement', 'View events | BCIPN');
    }

    public function userManagement() {
        $this->loadpage(null, 'UserManagement', 'View users | BCIPN');
    }

    public function report() {
        $this->loadpage(null, 'Report/ReportHome', 'Reports | BCIPN');
    }
    ...
    function slider() {
        ...
        if ($image_id > 0) {
            ...
            if ($success == 'no') {
                ...
                $this->loadpage($data, 'slider/slidermanager', 'Upload failed | BCIPN');
            } else if ($success == '1') {
                $data['err'] = '';
                $data['success'] = 'Images added to slider successfully.';
                $data['slider_images'] = $this->functionsmodel->getSliderImages(1, 1);
                $this->loadpage($data, 'slider/slidermanager', 'Upload success | BCIPN');
            } else {
    ...
    function slidermanager() {
        $data['slider_images'] = $this->functionsmodel->getSliderImages(1, 1);
        $this->loadpage($data, 'slider/slidermanager', 'Gallery Manager | BCIPN');
    }
    ...
    function eventOrganizer() {
        ...
        $this->loadpage($data, 'EventOrganizer', 'Manage event organizer | BCIPN');
    }
