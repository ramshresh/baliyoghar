				...
				<table border="0" width="50%" align="center">
					<tr>
						...
						<td align="left"><input type="text" name="event_end_date" id="event_end_date" class="datepicker"
												placeholder="Enter end date" value="<?php if (isset($to_date)) {
								echo $to_date;
							} ?>"/></td>
					</tr>
					<tr>
						...
						<td align="left">
                            <span id="coverage_location_content">
                                <select name="location" id="location">
									<!--<option value="">All</option>-->
									<?php
									if (isset($coverageLocationContent)) {
										echo $coverageLocationContent;
									}
									?>
									<!-- <?php
									/*                                   if(isset($location)){
...
<!--                                <select name="course" id="course" disabled="disabled">-->
                                <select name="course" id="course">
									...
									<?php
									if (isset($ContentSubCourse)) {
										echo $ContentSubCourse;
									}
									?>
									ContentSubCourse
									<?php /*if (isset($course)) {
				...
				<div id="search_result_summaryreport">
					...
					<br>
					<hr>
					<b class="nicecolor nicefont left"> Searched Report </b>
					<br>
