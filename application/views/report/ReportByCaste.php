    ...
    <table style="border:1px solid #CCC;margin-top:30px;" width="100%" class="maintable getBg">
        <tr>
            <td style="padding:20px;min-height:300px;display:block;text-align: center;vertical-align: middle">
                <h5 class="nicecolor">Report by Caste</h5>
                <?php $hidden = array('clicked' => 'yes');
                echo form_open('Report/castereport', '', $hidden) ?>
                ...
                <div id="search_result_peoplereport">
                    ...
                    <table class="dataListing" width="100%" border="0" cellpadding="0" cellpadding="5" border="0">
                        ...
                        <tr>
                            ...
                            <th height="28" colspan="9" align="center">Caste and Ethnicity</th>
                        ...
                        if (isset($castereport_array)) {
                            if (empty($castereport_array)) {
                                echo '<tr>No Reports found</tr>';
                            } else {
                                for ($i = 0; $i < count($castereport_array); $i++) {

                                    echo ' <tr>
                        <td>' . ($i + 1) . '&nbsp;</td>
                        <td><a href="../Event/viewEvent?id=' . $castereport_array[$i]['event_id'] . '">' . $castereport_array[$i]['title'] . '</a></td>
                        <td>' . $castereport_array[$i]['start_date'] . '</td>
                        <td>' . $castereport_array[$i]['end_date'] . '</td>


                         <td>' . $castereport_array[$i]['1'] . '</td>
                         <td>' . $castereport_array[$i]['2'] . '</td>
                         <td>' . $castereport_array[$i]['3'] . '</td>
                         <td>' . $castereport_array[$i]['4'] . '</td>
                         <td>' . $castereport_array[$i]['5'] . '</td>
                         <td>' . $castereport_array[$i]['6'] . '</td>
                         <td>' . $castereport_array[$i]['total'] . '</td>
