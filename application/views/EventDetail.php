        ...
        <tr>
                ...
                <table width="100%x" cellpadding="5" class="dataListing" id="event_detail_table">
                    <tr>
                        ...
                        <td align="left" width="80%"><span
                                class="text-success"><?php if (isset($title)) echo $title; ?></span></td>
                    </tr>
                    <tr>
            ...
            <tr class="whiteTd" >
                ...
                <a href="../Event/budgetEntry?id=<?= $event_id ?>" class="btn text-success"
                   style="margin-top:-6px;float: right;margin-bottom:0px;margin-right:5px" id=""><img
                        src="../img/edit.png"/>&nbsp;Edit budget entry</a>
                <table width="100%">
                    <tr>
                        <td width="50%" style="vertical-align: top">
                        ...
                        <td width="50%" style="vertical-align: top">
                            ...
                            <table width="300px" cellpadding="5" class="dataListing" id="cost_shares">
                                <tr>
                                    ...
                                    <td align="left" width="60%"> <?php if (isset($unit)) {
                                            echo $unit . ' ';
                                        }
                                        echo $directcost_array[0][0]; ?> </td>
                                </tr>
                                <tr>
                ...
                <table width="100%" cellpadding="5" class="dataListing">
                    ...
                    <tr>
                        ...
                        <td>
                            <h5 class="nicecolor"><?= $unit . ' ' . ($grandtotal + $directcost_array[0][0] + $directcost_array[0][1] + $directcost_array[0][2]) ?>
                                /-</h5></td>
                    </tr>
                    ...
                    if (isset($participants_array)) {
                        if (count($participants_array) > 0) {
                            for ($i = 0; $i < count($participants_array); $i++) {
                                echo "<tr data-idx=$i  id='participant_row_" . $participants_array[$i][0] . "'>";
