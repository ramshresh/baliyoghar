...
<style type="text/css">
	...
	label{display:inline-block;font-weight:bold;margin:0;padding:0;}
      ...
      <div class="span12">
        ...
        <div class="span9">
          ...
          <tr>
            ...
            <td width="21%"><?php if (isset($age)&& $age!=0) {echo '&nbsp;&nbsp;'.$age.' yrs';}else{echo 'n/a';} ?></td>
          </tr>
          <tr>
...
<tr><td width="120px"><label>Org Name : </label></td><td colspan="3"><?php if (isset($org_name)) echo $org_name; ?></td></tr>
<tr><td><label>Org Address : </label></td><td colspan="3"><?php if (isset($org_address)) echo $org_address; ?></td></tr>
<tr><td><label>Position : </label></td><td colspan="3"><?php if (isset($position)) echo $position; ?></td></tr>
<tr><td><label>Phone :</label> </td><td width="200px"><?php if (isset($org_phone)) echo $org_phone; ?></td><td><label>Fax : </label></td><td><?php if (isset($org_fax)) echo ' '.$org_fax; ?> </td></tr>
<tr><td><label>status : </label></td><td colspan="3"><?php if (isset($current_status)&& isset($updated_date)) echo $current_status.' as of date '.date("Y-m-d",strtotime( $updated_date));?></td></tr>
