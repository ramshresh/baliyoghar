...
<div class="container">
    ...
    <div class="container" style="width:980px;margin-bottom:50px" >
        ...
        <div id="help_icon">
            <center>
                <button title="Need help? click here." class="nicefont btn btn-info  text-info size16" style="cursor:pointer" onClick="$('#mainContent').slideToggle('slow');">About bcipn</button><br/>
            </center>
