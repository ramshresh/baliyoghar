...
<div class="container">
                ...
                <h5 class="inline-block">Add new participants </h5>
                 ...
                 <!--tr>
                        <td colspan="2" align="right" style="border:none"-->
                            <a href="../Event/budgetEntry?id=<?= $event_id ?>" class="btn text-success" style="bottom:5px;float:right;" id=""><img src="../img/edit.png" />&nbsp;Edit budget entry</a>
                        <!--/td>
                    </tr-->
                    ...
                    <tr class="message-info " >
                        ...
                        <td colspan="2" >
                            <div style="float:left" >&nbsp;
                                ...
                                <?php
                                echo form_input(array('name' => 'person_name', 'id' => 'person_name', 'placeholder' => 'Enter name', 'class' => 'required', 'minlength' => 2, 'maxlength' => 60, 'style' => 'width:150px'));
                                ?>
                            </div>
                            <div style="float:left" >
                                &nbsp; |
                                ...
                                <input type="text" name="person_dob_np"  id="person_dob_np"  placeholder="DOB" style="width:80px"/>
                                &nbsp; |
                                <span class="nicecolor"> DOB(en) : </span>
                                <input type="text" name="person_dob_en"  id="person_dob_en"  placeholder="DOB" style="width:80px"/>
                                &nbsp; | 
                                <span class="nicecolor">  Mobile : </span>
                                <input type="text" id="person_mobile" name="person_mobile"  placeholder="Enter mobile no." style="width:120px"/> 
                                &nbsp; |
                                <span class="nicecolor">Phone : </span>
                                <input type="text" id="person_phone" name="person_phone" placeholder="Enter phone no." style="width:80px"/> 
                        ...
                        <td  style="padding-top:20px;vertical-align: top">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" id ="person_paddress" name="person_paddress" placeholder="Enter permanent address"/> </td>
                                </tr>
                                <tr>
                                    <td><label>Contact address</label> </td>
                                    <td><input type="text" id="person_caddress" name="person_caddress" placeholder="Enter contact address"/> </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div id="reset_message">
                                            <br />
                                            <br /><p class="text-error" id="participant_note" style="display:none">#Note:<i> To insert new record, press reset.</i></p>
                                        </div>
                                    </td>
                                </tr>
                            </table>

                        </td><td  style="padding-top:20px;vertical-align: top">
                            <table border="0" >
                                <tr>
                                    <td><label>Email</label> </td>
                                    <td><input type="text" id="person_email" name="person_email"  placeholder="Enter email"/> </td>
                                </tr>
                                <tr>
                                    <td><label>Organization name</label> </td>
                                    <td><input type="text" id="person_org_name" name="person_org_name" placeholder="Enter org. name"/> </td>
                                </tr>
                                <tr>
                                    <td style="padding-right:10px"><label>Organization address</label> </td>
                                    <td><input type="text" id="person_org_address" name="person_org_address" placeholder="Enter org. address"/> </td>
                                </tr>
                                <tr>
                                    <td><label>Organization phone</label> </td>
                                    <td><input type="text" id="person_org_phone" name="person_org_phone" placeholder="Enter org. phone"/> </td>
                                </tr>
                                <tr>
                                    <td><label>Organization fax</label> </td>
                                    <td><input type="text" id="person_org_fax" name="person_org_fax"  placeholder="Enter org. fax"/> </td>
                                </tr>
                                <tr>
                                    <td><label>Position</label> </td>
                                    <td><input type="text" id="person_position" name="person_position" id="person_position" placeholder="Enter position"/> </td>
                                </tr>
                                <tr>
                                            ...
                                            <tr>
                                                <td >
                                                    <div id="instructor_selection">
                                                        <h5 >Please select:</h5><hr style="margin:5px;"/>

                                                        <input type="radio" id ="person_participant" name="participant_type" checked value="0"/> &nbsp;<label for="person_participant" style="display:inline-block" >Participant</label>
                                                        &nbsp;&nbsp; | &nbsp;&nbsp;
                                                        <input type="radio" id ="person_inst" name="participant_type" value="1"/> &nbsp;<label for="person_inst" style="display:inline-block" >Instructor</label>
                                                        &nbsp;&nbsp; | &nbsp;&nbsp;
                                                        <input type="radio" value="2" id="person_asstinst" name="participant_type" /> &nbsp;<label for="person_asstinst" style="display:inline-block" >Asst. Instructor</label>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <tr>
                                    ...
                                    <td  colspan="2" align="right">
                                        ...
                                        <span style="float:right">
                                            <input type="submit" class="btn btn-info" id="add_new_person_btn" value="Save data"/>
    ...
    <table style="border:1px solid #CCC;margin-top:30px;display:none" width="100%" id="participants_results" >
        <tr>
            <td style="padding:20px">
                <h5 style="margin:5px" class="text-info inline-block">Search result</h5><sub class="text-error handcursor" id="person_close" >&nbsp;(close)</sub><sub class="text-error handcursor btn btn-primary" id="force_add" style="float:right;margin-bottom: 10px;" onclick="$('#person_tablebody').show(); $('#participants_results').hide();" >&nbsp;Force Add</sub>
                <table class="dataListing" id="participants_search_result" width="100%" id=""  cellspacing="0" cellpadding="5" border="0">
                    <!--tr>
